...
export default function RegisterAdminModal({
  ...
  return (
    ...
    >
      ...
      <div
        className={[
          "relative w-155 max-w-[95vw] rounded-2xl bg-white shadow-2xl border border-black/10 overflow-hidden",
      ...
      >
        {/* Header */}
        <div className="shrink-0 px-5 sm:px-6 py-4 border-b border-black/10 flex items-start justify-between gap-3">
          ...
          <div className="p-5 sm:p-6">
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              {isSuperAdmin ? (
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-black/10 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/40 transition bg-white text-gray-900 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="space-y-1">
                ...
                <input
                  className="w-full rounded-xl border border-black/10 bg-white px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/40 transition"
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-black/10 bg-white px-3 py-2 pr-11 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/40 transition"
                    placeholder="••••••••"
                    value={password}
