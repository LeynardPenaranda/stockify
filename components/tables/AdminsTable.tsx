...
import { Shield, ShieldCheck, Trash2, User, UserX } from "lucide-react";
      ...
      <table className="min-w-245 w-full text-sm">
        ...
        <tbody>
          {admins.map((a) => {
            ...
            const canManage = isSuperAdmin && !isMe; // prevent self-disable/delete in UI
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center justify-end gap-2">
                    ...
                    <button
                      ...
                      disabled={!canManage}
                      className={[
                        "inline-flex items-center gap-2 rounded-xl border border-black/10 bg-white px-3 py-2 text-xs font-semibold text-gray-800",
