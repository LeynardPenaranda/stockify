    ...
    >
      {(title || right) && (
        <div className="mb-3 flex items-center justify-between gap-3">
          <div className="text-sm font-semibold text-[#17335e]">{title}</div>
          {right ? <div className="text-xs text-[#17335e]">{right}</div> : null}
        </div>
      )}
      {children}
    </div>
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="text-[11px] font-medium uppercase tracking-wide text-[#17335e]">
            {label}
          </div>
          <div className="mt-2 text-2xl font-semibold text-[#17335e]">
            {value}
          </div>
          {sub ? (
            <div className="mt-1 text-[11px] leading-4 text-[#17335e]">
              {sub}
            </div>
          ) : null}
        </div>
      ...
      {payload.map((entry) => {
        ...
        return (
          <div key={label} className="flex items-center gap-1" title={label}>
            ...
            />
            {!compact ? (
              <span className="text-[11px] text-[#17335e]">{label}</span>
            ) : null}
          </div>
        );
      })}
      ...
      <div className="w-full px-4 py-4 md:px-6 md:py-6">
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 lg:grid-cols-3">
          ...
          >
            ...
            <div className="mt-2 text-[11px] text-[#17335e]">
                    ...
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0">
                        ...
                        {ev.deltaQuantity !== null ? (
                          <div className="mt-1 text-[11px] text-[#17335e]">
                            Qty:{" "}
                            <span className="font-semibold text-[#17335e]">
                              {ev.deltaQuantity > 0
                                ? `+${ev.deltaQuantity}`
                                : ev.deltaQuantity}
                            </span>
                      ...
                      <div className="text-right">
                        <div className="text-[11px] font-semibold text-[#17335e]">
                          {ev.atLabel}
                        </div>
                      </div>
                    </div>
